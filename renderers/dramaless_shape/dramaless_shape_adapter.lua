local DramalessShapeAdapter = {}

DramalessShapeAdapter.info = {
...
function DramalessShapeAdapter.detect(
    mod
)
...
function DramalessShapeAdapter.initialize(
    mod,
    loadLocalModule,
    Registry,
    CharacterRuntime
